...
#' @param min,max Optional numeric bounds for continuous FILTER clauses. Each
#'   must be a single finite number when supplied; `NA`, `Inf`, a string, and
#'   a vector raise a `picsureError`. The value's own numeric type is
